...
func stageHardcodedUpgrades(store *Store) bool {
	...
	if pending.Upgrades.VinuBLS12381 && !es.Rules.Upgrades.Prague {
		pending.Upgrades.VinuBLS12381 = false
		changed = true
	...
	if hardcoded.Upgrades.VinuBLS12381 && !pending.Upgrades.VinuBLS12381 {
		if es.Rules.Upgrades.Prague {
			pending.Upgrades.VinuBLS12381 = true
			changed = true
	...
	if hardcoded.Upgrades.SfcV2Patch7 && !pending.Upgrades.SfcV2Patch7 {
		pending.Upgrades.SfcV2Patch7 = true
		changed = true
		log.Info("Staged SfcV2Patch7 upgrade from binary rules; will activate at next epoch seal")
	}
	if hardcoded.Upgrades.SfcV2Patch8 && !pending.Upgrades.SfcV2Patch8 {
		pending.Upgrades.SfcV2Patch8 = true
		changed = true
		log.Info("Staged SfcV2Patch8 upgrade from binary rules; will activate at next epoch seal")
	}
	if hardcoded.Upgrades.SfcV2Patch9 && !pending.Upgrades.SfcV2Patch9 {
		pending.Upgrades.SfcV2Patch9 = true
		changed = true
