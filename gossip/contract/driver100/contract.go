...
//
// Solidity: function swapCode(address acc, address withh) returns()
func (_Contract *ContractTransactor) SwapCode(opts *bind.TransactOpts, acc common.Address, withh common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "swapCode", acc, withh)
}

// SwapCode is a paid mutator transaction binding the contract method 0x07690b2a.
//
// Solidity: function swapCode(address acc, address withh) returns()
func (_Contract *ContractSession) SwapCode(acc common.Address, withh common.Address) (*types.Transaction, error) {
	return _Contract.Contract.SwapCode(&_Contract.TransactOpts, acc, withh)
}

// SwapCode is a paid mutator transaction binding the contract method 0x07690b2a.
//
// Solidity: function swapCode(address acc, address withh) returns()
func (_Contract *ContractTransactorSession) SwapCode(acc common.Address, withh common.Address) (*types.Transaction, error) {
	return _Contract.Contract.SwapCode(&_Contract.TransactOpts, acc, withh)
}
