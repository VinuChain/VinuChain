...
type EVM interface {
	Start(block iblockproc.BlockCtx, statedb *state.StateDB, reader evmcore.DummyChain, onNewLog func(*types.Log), net opera.Rules, vmConfig vm.Config, evmCfg *params.ChainConfig, paybackCache *payback.PaybackCache, epoch idx.Epoch) EVMProcessor
}
