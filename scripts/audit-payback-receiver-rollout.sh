...
run_shell_step \
  ...
  rg -q 'repositoryActionsVariables' \"\$owner_action_audit\"
  ...
  rg -q 'Prepared max gas cost wei:' <<<\"\$handoff_output\"
  rg -q 'ProxyAdmin owner balance wei:' <<<\"\$handoff_output\"
  rg -q 'Owner balance covers prepared gas:' <<<\"\$handoff_output\"
  ...
  rg -q 'Repository PRIVATE_TEST variable present:' <<<\"\$handoff_output\"
  rg -q 'Repository variable note:' <<<\"\$handoff_output\"
  ...
  rg -q 'Local owner material sweep' <<<\"\$handoff_output\"
  rg -q 'ProxyAdmin owner key matches:' <<<\"\$handoff_output\"
  rg -q 'Expected signed upgrade txs:' <<<\"\$handoff_output\"
