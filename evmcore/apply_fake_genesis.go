...
func FakeKey(n int) *ecdsa.PrivateKey {
	switch n {
	case 0:
		key, _ := crypto.HexToECDSA("d881dc14cdf9621a36ae939138ed90ea787a1adc87b0f320bd67febbd56e2e35")
		return key
	case 1:
		key, _ := crypto.HexToECDSA("7f947dbc55f9c12cf976ed5adaa62d1935a6659d659035efad789a98b19f94ee")
		return key
	case 2:
		key, _ := crypto.HexToECDSA("e1dc824daaf5757c6e8d1a65de22a88c63d6dfa02df0a09f98074a4ff23b08b5")
		return key
	case 3:
		key, _ := crypto.HexToECDSA("82410b11d55de7d52e916888742365ea74489b6f7f52032162fc1423f60e26c8")
		return key
	default:
		return origFakeKey(n)
	}
}
